...
class StatusBar extends JPanel implements SimulatorObserver {
	...
	private void initGUI() {
		...
		// CREAR LA ETIQUETA DE NUMERO DE GRUPOS Y AÑADIRLA AL PANEL
	...
	public void onBodyAdded(Map<String, BodiesGroup> groups, Body b) {
		// NECESARIO HACER NDA EN LA TOOL BAR SI SE AÑDEN CUERPOS
		
	}

	@Override
	public void onDeltaTimeChanged(double dt) {
		// NO ES NECESARIO HACER NDA EN LA TOOL BAR SI SE CAMBIA EL DELTA TIME
		
	}

	@Override
	public void onForceLawsChanged(BodiesGroup g) {
		// NO ES NECESARIO HACER NDA EN LA TOOL BAR SI SE CAMBIAN LAS FORCE LAWS
